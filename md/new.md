...
*2. [Consumers](#1798.140(i)) should be able to control the use of their [personal
...
*4. [Businesses](#1798.140(d)) should provide [consumers](#1798.140(i)) or their authorized agents with
...
*8. To the extent it advances [consumer](#1798.140(i)) privacy and [business](#1798.140(d)) compliance,
...
information](#1798.140(v)) are used, and whether such [personal information](#1798.140(v)) is [sold](#1798.140(ad)), in
...
*(f) Nothing in this section shall require a [business](#1798.140(d)) to disclose trade
...
with a deletion request submitted by the [consumer](#1798.140(i)) directly to the
...
\(5) The specific pieces of [personal information](#1798.140(v)) it has [collected](#1798.140(f)) about
...
\(1) The categories of [personal information](#1798.140(v)) that the [business](#1798.140(d)) [collected](#1798.140(f))
...
*(d) [Sensitive Personal Information](#1798.140(ae)) that is [collected](#1798.140(f)) or processed
...
\(2) A [business](#1798.140(d)) that offers any financial incentives pursuant to this
...
\(C) Identify by category or categories the [personal information](#1798.140(v)) of the
...
\(ii) A list of the categories of [personal information](#1798.140(v)) it has disclosed
...
\(1) Provide a clear and conspicuous link on the [business](#1798.140(d))'s Internet
...
the opt-out preference signal with respect to that [business](#1798.140(d))\'s [sale](#1798.140(ad)) or
[sharing](#1798.140(ah)) of the [consumer](#1798.140(i))\'s [personal information](#1798.140(v)) or the use of the
[consumer](#1798.140(i))\'s [sensitive personal information](#1798.140(ae)) for additional purposes
provided that:*

*(A) the [consent](#1798.140(h)) webpage also allows the [consumer](#1798.140(i)) or a [person](#1798.140(u)) authorized
...
\(5) For  *[consumers](#1798.140(i)) under 16 years of
...
*(1) [selling](#1798.140(ad)) or [sharing](#1798.140(ah)) the [personal information](#1798.140(v)); or*
...
\(1) Auditing related  counting ad
...
\(*f*) "[Collects](#1798.140(f))," "[collected](#1798.140(f))," or "[collection](#1798.140(f))" means buying,
...
*(B) Includes a certification made by [contractor](#1798.140(j)) that the [contractor](#1798.140(j))
...
\(*o*) "[Device](#1798.140(o))" means any physical object that is capable of
...
the [consumer](#1798.140(i))'s knowledge.
 ...
 "[Personal information](#1798.140(v))" does not include [consumer](#1798.140(i)) information
...
\(2) Subsequently pseudonymized and [deidentified](#1798.140(m)), or [deidentified](#1798.140(m)) and in
...
*(ii)*  [intentionally interact](#1798.140(s)) with  *one
...
*(A) the [processing](#1798.140(y)) of [biometric information](#1798.140(c)) for the purpose of uniquely
...
*(2) If a [service provider](#1798.140(ag)) engages any other [person](#1798.140(u)) to assist it in
...
family, or a [device](#1798.140(o)) that is linked to a [consumer](#1798.140(i)) or family, over time
and across different [services](#1798.140(af)), including, but not limited to, a [device](#1798.140(o))
...
persistent or [probabilistic identifiers](#1798.140(x)) that can be used to identify a
particular [consumer](#1798.140(i)) or [device](#1798.140(o)) *that is linked to a [consumer](#1798.140(i)) or family*.
For purposes of this subdivision, "family" means a custodial parent or
guardian and any  children *under 18 years of age* over which
the parent or guardian has custody.

\(*ak*) "[Verifiable consumer request](#1798.140(ak))" means a request that is made
by a [consumer](#1798.140(i)), by a [consumer](#1798.140(i)) on behalf of the [consumer](#1798.140(i))'s minor child, or
by a natural [person](#1798.140(u)) or a [person](#1798.140(u)) registered with the Secretary of State,
authorized by the [consumer](#1798.140(i)) to act on the [consumer](#1798.140(i))'s behalf, *or by a
[person](#1798.140(u)) who has power of attorney or is acting as a conservator for the
[consumer](#1798.140(i)),* and that the [business](#1798.140(d)) can  verify, *using
...
1798.185 to be the [consumer](#1798.140(i)) about whom the [business](#1798.140(d)) has [collected](#1798.140(f))
[personal information](#1798.140(v)). A [business](#1798.140(d)) is not obligated to provide information
to the [consumer](#1798.140(i)) pursuant to Sections 1798.100, 1798.105, 1798.110, and
1798.115*, to delete [personal information](#1798.140(v)) pursuant to Section 1798.105,
or to correct inaccurate [personal information](#1798.140(v)) pursuant to Section
1798.106,* if the [business](#1798.140(d)) cannot verify, pursuant to this subdivision
and regulations adopted by the Attorney General pursuant to paragraph
(7) of subdivision (a) of Section 1798.185, that the [consumer](#1798.140(i)) making the
request is the [consumer](#1798.140(i)) about whom the [business](#1798.140(d)) has [collected](#1798.140(f))
information or is a [person](#1798.140(u)) authorized by the [consumer](#1798.140(i)) to act on such
[consumer](#1798.140(i))'s behalf.
...
\(a) The obligations imposed on [businesses](#1798.140(d)) by this title shall not
restrict a [business](#1798.140(d))' ability to:
...
direct a [business](#1798.140(d)) pursuant to a law enforcement agency-approved
investigation with an active case number not to delete a [consumer](#1798.140(i))\'s
[personal information](#1798.140(v)) and upon receipt of such direction a [business](#1798.140(d)) shall
not delete the [personal information](#1798.140(v)) for 90 days, in order to allow the
law enforcement agency to obtain a court-issued subpoena, order, or
warrant to obtain a [consumer](#1798.140(i))\'s [personal information](#1798.140(v)). For good cause and
only to the extent necessary for investigatory purposes, law enforcement
agency may direct a [business](#1798.140(d)) not to delete the [consumer](#1798.140(i))\'s [personal
information](#1798.140(v)) for additional 90 day periods. A [business](#1798.140(d)) that has received
direction from a law enforcement agency not to delete the [personal
information](#1798.140(v)) of a [consumer](#1798.140(i)) who has requested deletion of the [consumer](#1798.140(i))\'s
[personal information](#1798.140(v)) shall not use the [consumer](#1798.140(i))\'s [personal information](#1798.140(v))
...
[consumer](#1798.140(i))\'s deletion request is subject to an exemption from deletion
under this title.*

\(3) Cooperate with law enforcement agencies concerning conduct or
activity that the [business](#1798.140(d)), [service provider](#1798.140(ag)), or [third party](#1798.140(ai)) reasonably
...
a [consumer](#1798.140(i))\'s [personal information](#1798.140(v)) if a natural [person](#1798.140(u)) is at risk or
danger of death or serious physical injury, provided that:*

*(A) the request is approved by a high-ranking agency officer for
emergency access to a [consumer](#1798.140(i))\'s [personal information](#1798.140(v));*
...
\(*6*) [Collect](#1798.140(f)), use, retain, [sell](#1798.140(ad)), *[share](#1798.140(ah)),* or disclose [consumer](#1798.140(i))*s'*
*personal* information that is [deidentified](#1798.140(m)) or in the [aggregate consumer
information](#1798.140(b)).

\(*7*) [Collect](#1798.140(f))*,*  [sell](#1798.140(ad))*, or [share](#1798.140(ah))* a [consumer](#1798.140(i))'s [personal
information](#1798.140(v)) if every aspect of that commercial conduct takes place
wholly outside of California. For purposes of this title, commercial
conduct takes place wholly outside of California if the [business](#1798.140(d))
[collected](#1798.140(f)) that information while the [consumer](#1798.140(i)) was outside of California,
no part of the [sale](#1798.140(ad)) of the [consumer](#1798.140(i))'s [personal information](#1798.140(v)) occurred in
California, and no [personal information](#1798.140(v)) [collected](#1798.140(f)) while the [consumer](#1798.140(i)) was
in California is [sold](#1798.140(ad)). This paragraph shall not  *prohibit* a
[business](#1798.140(d)) from storing, including on a [device](#1798.140(o)), [personal information](#1798.140(v)) about
a [consumer](#1798.140(i)) when the [consumer](#1798.140(i)) is in California and then [collecting](#1798.140(f)) that
[personal information](#1798.140(v)) when the [consumer](#1798.140(i)) and stored [personal information](#1798.140(v))
is outside of California.

\(b) The obligations imposed on [businesses](#1798.140(d)) by Sections 1798.110*,
1798.115, 1798.120, 1798.121, 1798.130,*  *and* 1798.135,
inclusive, shall not apply where compliance by the [business](#1798.140(d)) with the
title would violate an evidentiary privilege under California law and
shall not prevent a [business](#1798.140(d)) from providing the [personal information](#1798.140(v)) of
a [consumer](#1798.140(i)) to a [person](#1798.140(u)) covered by an evidentiary privilege under
...
protected health information that is [collected](#1798.140(f)) by a covered entity or
[business](#1798.140(d)) associate governed by the privacy, security, and breach
notification rules issued by the United States Department of Health and
Human [Services](#1798.140(af)), Parts 160 and 164 of Title 45 of the Code of Federal
...
\(C) *Personal* information [collected](#1798.140(f)) as part of a clinical trial *or
other biomedical [research](#1798.140(ab)) study* subject to *or conducted in accordance
...
Administration*, provided that such information is not [sold](#1798.140(ad)) or [shared](#1798.140(ah)) in
a manner not permitted by this subparagraph, and if it is inconsistent,
that the participants be informed of such use and provide [consent](#1798.140(h))*.
...
and the definitions of "[business](#1798.140(d)) associate," "covered entity," and
"protected health information" in Section 160.103 of Title 45 of the
Code of Federal Regulations shall apply.

\(d)

\(1) This title shall not apply to an activity involving the [collection](#1798.140(f)),
maintenance, disclosure, [sale](#1798.140(ad)), communication, or use of any [personal
information](#1798.140(v)) bearing on a [consumer](#1798.140(i))'s credit worthiness, credit standing,
credit capacity, character, general reputation, personal
characteristics, or mode of living by a [consumer](#1798.140(i)) reporting agency, as
...
for use in a [consumer](#1798.140(i)) report, as defined in subdivision (d) of Section
1681a of Title 15 of the United States Code, and by a user of a [consumer](#1798.140(i))
...
involving the [collection](#1798.140(f)), maintenance, disclosure, [sale](#1798.140(ad)), communication,
...
communicated, disclosed, or [sold](#1798.140(ad)) except as authorized by the Fair Credit
Reporting Act.

\(3) This subdivision shall not apply to Section 1798.150.

\(e) This title shall not apply to [personal information](#1798.140(v)) [collected](#1798.140(f)),
processed, [sold](#1798.140(ad)), or disclosed  *subject* to the federal
...
\(f) This title shall not apply to [personal information](#1798.140(v)) [collected](#1798.140(f)),
processed, [sold](#1798.140(ad)), or disclosed pursuant to the Driver's Privacy
...
information retained or [shared](#1798.140(ah)) between a new motor vehicle dealer, as
...
vehicle or ownership information is [shared](#1798.140(ah)) for the purpose of
...
which that vehicle information or ownership information is [shared](#1798.140(ah)) does
not [sell](#1798.140(ad)), [share](#1798.140(ah)), or use that information for any other purpose.
...
\(A) [Personal information](#1798.140(v)) that is [collected](#1798.140(f)) by a [business](#1798.140(d)) about a natural
[person](#1798.140(u)) in the course of the natural [person](#1798.140(u)) acting as a job applicant to,
an employee of, owner of, director of, officer of, medical staff member
of, or [contractor](#1798.140(j)) of that [business](#1798.140(d)) to the extent that the natural
[person](#1798.140(u))'s [personal information](#1798.140(v)) is [collected](#1798.140(f)) and used by the [business](#1798.140(d))
solely within the context of the natural [person](#1798.140(u))'s role or former role as
a job applicant to, an employee of, owner of, director of, officer of,
medical staff member of, or a [contractor](#1798.140(j)) of that [business](#1798.140(d)).

\(B) [Personal information](#1798.140(v)) that is [collected](#1798.140(f)) by a [business](#1798.140(d)) that is
emergency contact information of the natural [person](#1798.140(u)) acting as a job
applicant to, an employee of, owner of, director of, officer of, medical
staff member of, or [contractor](#1798.140(j)) of that [business](#1798.140(d)) to the extent that the
[personal information](#1798.140(v)) is [collected](#1798.140(f)) and used solely within the context of
having an emergency contact on file.

\(C) [Personal information](#1798.140(v)) that is necessary for the [business](#1798.140(d)) to retain to
administer benefits for another natural [person](#1798.140(u)) relating to the natural
[person](#1798.140(u)) acting as a job applicant to, an employee of, owner of, director
of, officer of, medical staff member of, or [contractor](#1798.140(j)) of that [business](#1798.140(d))
to the extent that the [personal information](#1798.140(v)) is [collected](#1798.140(f)) and used solely
within the context of administering those benefits.

\(2) For purposes of this subdivision:

\(A) "[Contractor](#1798.140(j))" means a natural [person](#1798.140(u)) who provides any [service](#1798.140(af)) to a
[business](#1798.140(d)) pursuant to a written contract.

\(B) "Director" means a natural [person](#1798.140(u)) designated in the articles of
incorporation as such or elected by the incorporators and natural
[persons](#1798.140(u)) designated, elected, or appointed by any other name or title to
...
Section 500) of the [Business](#1798.140(d)) and Professions Code and a clinical
psychologist as defined in Section 1316.5 of the Health and Safety Code.

\(D) "Officer" means a natural [person](#1798.140(u)) elected or appointed by the board
...
\(E) "Owner" means a natural [person](#1798.140(u)) who meets one of the following:

\(i) Has ownership of, or the power to vote, more than 50 percent of the
outstanding [shares](#1798.140(ah)) of any class of voting security of a [business](#1798.140(d)).
...
\(i) Notwithstanding a [business](#1798.140(d))' obligations to respond to and honor
[consumer](#1798.140(i)) rights requests pursuant to this title:

\(1) A time period for a [business](#1798.140(d)) to respond to *a [consumer](#1798.140(i)) for* any
 *verifiable* [consumer](#1798.140(i)) request may be extended by up to *a
total of* 90  days where necessary, taking into account
the complexity and number of the requests. The [business](#1798.140(d)) shall inform the
[consumer](#1798.140(i)) of any such extension within 45 days of receipt of the request,
together with the reasons for the delay.

\(2) If the [business](#1798.140(d)) does not take action on the request of the [consumer](#1798.140(i)),
the [business](#1798.140(d)) shall inform the [consumer](#1798.140(i)), without delay and at the latest
within the time period permitted of response by this section, of the
reasons for not taking action and any rights the [consumer](#1798.140(i)) may have to
appeal the decision to the [business](#1798.140(d)).

\(3) If requests from a [consumer](#1798.140(i)) are manifestly unfounded or excessive,
in particular because of their repetitive character, a [business](#1798.140(d)) may
...
requested, or refuse to act on the request and notify the [consumer](#1798.140(i)) of
the reason for refusing the request. The [business](#1798.140(d)) shall bear the burden
of demonstrating that any  *verifiable* [consumer](#1798.140(i)) request is
manifestly unfounded or excessive.

\(j)

*(1)* A [business](#1798.140(d)) that discloses [personal information](#1798.140(v)) to a [service
provider](#1798.140(ag)) *or [contractor](#1798.140(j)) in compliance with this title* shall not be
liable under this title if the [service provider](#1798.140(ag)) *or [contractor](#1798.140(j))*
receiving the [personal information](#1798.140(v)) uses it in violation of the
restrictions set forth in the title, provided that, at the time of
disclosing the [personal information](#1798.140(v)), the [business](#1798.140(d)) does not have actual
knowledge, or reason to believe, that the [service provider](#1798.140(ag)) *or
[contractor](#1798.140(j))* intends to commit such a violation. A [service provider](#1798.140(ag)) *or
[contractor](#1798.140(j))* shall likewise not be liable under this title for the
obligations of a [business](#1798.140(d)) for which it provides [services](#1798.140(af)) as set forth in
this title*, provided that the [service provider](#1798.140(ag)) or [contractor](#1798.140(j)) shall be
liable for its own violations of this title*.

*(2)* *A [business](#1798.140(d)) that discloses [personal information](#1798.140(v)) of a [consumer](#1798.140(i)),
with the exception of [consumers](#1798.140(i)) who have exercised their right to
opt-out of the [sale](#1798.140(ad)) or [sharing](#1798.140(ah)) of their [personal information](#1798.140(v)), [consumers](#1798.140(i))
who have limited the use or disclosure of their [sensitive personal
information](#1798.140(ae)), and minor [consumers](#1798.140(i)) who have not opted-in to the [collection](#1798.140(f))
or [sale](#1798.140(ad)) of their [personal information](#1798.140(v)), to a [third party](#1798.140(ai)) pursuant to a
written contract that requires the [third party](#1798.140(ai)) to provide the same level
of protection of the [consumer](#1798.140(i))\'s rights under this title as provided by
the [business](#1798.140(d)) shall not be liable under this title if the [third party](#1798.140(ai))
receiving the [personal information](#1798.140(v)) uses it in violation of the
restrictions set forth in the title, provided that, at the time of
disclosing the [personal information](#1798.140(v)), the [business](#1798.140(d)) does not have actual
knowledge, or reason to believe, that the [third party](#1798.140(ai)) intends to commit
such a violation.*

\(k) This title shall not be construed to require a [business](#1798.140(d))*, [service
provider](#1798.140(ag)), or [contractor](#1798.140(j))* to*:*

*(1) reidentify or otherwise link information that, in the ordinary
course of [business](#1798.140(d)), s not maintained in a manner that would be
considered [personal information](#1798.140(v));*

*(2) retain any [personal information](#1798.140(v)) about a [consumer](#1798.140(i)) if, in the
ordinary course of [business](#1798.140(d)), that information about the [consumer](#1798.140(i)) would
not be retained; or*

*(3) maintain information in identifiable, linkable or associable form,
or [collect](#1798.140(f)), obtain, retain, or access any data or technology, in order
to be capable of linking or associating a [verifiable consumer request](#1798.140(ak))
with [personal information](#1798.140(v)).*



\(l) The rights afforded to [consumers](#1798.140(i)) and the obligations imposed on the
[business](#1798.140(d)) in this title shall not adversely affect the rights and
freedoms of other  *natural [persons](#1798.140(u)). A [verifiable consumer
request](#1798.140(ak)) for specific pieces of [personal information](#1798.140(v)) pursuant to section
1798.110, to delete a [consumer](#1798.140(i))'s [personal information](#1798.140(v)) pursuant to
Section 1798.105, or to correct inaccurate [personal information](#1798.140(v)) pursuant
to Section 1798.106, shall not extend to [personal information](#1798.140(v)) about the
[consumer](#1798.140(i)) that belongs to, or the [business](#1798.140(d)) maintains on behalf of,
another natural [person](#1798.140(u)). A [business](#1798.140(d)) may rely on representations made in a
[verifiable consumer request](#1798.140(ak)) as to rights with respect to [personal
information](#1798.140(v)) and is under no legal requirement to seek out other [persons](#1798.140(u))
that may have or claim to have rights to [personal information](#1798.140(v)), and a
[business](#1798.140(d)) is under no legal obligation under this title or any other
provision of law to take any action under this title in the event of a
dispute between or among [persons](#1798.140(u)) claiming rights to [personal information](#1798.140(v))
in the [business](#1798.140(d))'s possession.*

\(m) The rights afforded to [consumers](#1798.140(i)) and the obligations imposed on any
[business](#1798.140(d)) under this title shall not apply to the extent that they
infringe on the noncommercial activities of a [person](#1798.140(u)) or entity described
in subdivision (b) of Section 2 of Article I of the California
Constitution.

\(n)

\(1) The obligations imposed on [businesses](#1798.140(d)) by Sections 1798.100,
1798.105, 1798.110, 1798.115, 1798.130, and 1798.135 shall not apply to
[personal information](#1798.140(v)) reflecting a written or verbal communication or a
transaction between the [business](#1798.140(d)) and the [consumer](#1798.140(i)), where the [consumer](#1798.140(i)) is
a natural [person](#1798.140(u)) who is acting as an employee, owner, director, officer,
or [contractor](#1798.140(j)) of a company, partnership, sole proprietorship,
non-profit, or government agency and whose communications or transaction
with the [business](#1798.140(d)) occur solely within the context of the [business](#1798.140(d))
conducting due diligence regarding, or providing or receiving a product
or [service](#1798.140(af)) to or from such company, partnership, sole proprietorship,
...
\(C) "Officer" means a natural [person](#1798.140(u)) elected or appointed by the board
of directors to manage the daily operations of a corporation, such as a
chief executive officer, president, secretary, or treasurer.

\(D) "Owner" means a natural [person](#1798.140(u)) who meets one of the following:
...
credit reporting agency\'s [collection](#1798.140(f)), [processing](#1798.140(y)), [sale](#1798.140(ad)), or disclosure
of [business](#1798.140(d)) controller information to the extent the commercial credit
reporting agency uses the [business](#1798.140(d)) controller information solely to
Identify the relationship of a [consumer](#1798.140(i)) to a [business](#1798.140(d)) which the [consumer](#1798.140(i))
owns or contact the [consumer](#1798.140(i)) only in the [consumer](#1798.140(i))\'s role as the owner,
director, officer, or management employee of the [business](#1798.140(d)).*

*(2) For the purposes of this subdivision:*

*(A) \"[Business](#1798.140(d)) controller information\" means the name or names of the
owner or owners, director, officer, or management employee of a
[business](#1798.140(d)), and the contact information, including a [business](#1798.140(d)) title, for
...
*(C) \"Owner or owners\" means a natural [person](#1798.140(u)) that meets one of the
following:*
...
*(C) \"Director\" means a natural [person](#1798.140(u)) designated in the articles of
incorporation of a [business](#1798.140(d)) as such or elected by the incorporators and
natural [persons](#1798.140(u)) designated, elected or appointed by any other name or
title to act as directors, and their successors.*

*(D) \"Officer\" means a natural [person](#1798.140(u)) elected or appointed by the
board of directors of a [business](#1798.140(d)) to manage the daily operations of a
corporation, such as a chief executive officer, president, secretary, or
treasurer.*

*(E) \"Management employee\" means a natural [person](#1798.140(u)) whose name and
contact information is reported to or [collected](#1798.140(f)) by a commercial credit
reporting agency as the primary manager of a [business](#1798.140(d)) and used solely
within the context of the natural [person](#1798.140(u))\'s role as the primary manager
of the [business](#1798.140(d)).*

*(p) The obligations imposed on [businesses](#1798.140(d)) in Sections 1798.105,
1798.106, 1798.110, and 1798.115 inclusive, shall not apply to [household](#1798.140(q))
data.*

*(q)*

*(1) This title does not require a [business](#1798.140(d)) to comply with a [verifiable
consumer request](#1798.140(ak)) to delete a [consumer](#1798.140(i))\'s [personal information](#1798.140(v)) under
Section 1798.105 to the extent the [verifiable consumer request](#1798.140(ak)) applies
to a student\'s grades, educational scores, or educational test results
that the [business](#1798.140(d)) holds on behalf of a local educational agency, as
defined in subdivision (d) of Section 49073.1 of the Education Code, at
which the student is currently enrolled. If a [business](#1798.140(d)) does not comply
with a request pursuant to this section, it shall notify the [consumer](#1798.140(i))
that it is acting pursuant to this exception,*

*(2) This title does not require, in response to a request pursuant to
Section 1798.110, that a [business](#1798.140(d)) disclose an educational standardized
assessment or educational assessment or a [consumer](#1798.140(i))\'s specific responses
to the educational standardized assessment or educational assessment
where [consumer](#1798.140(i)) access, possession or control would jeopardize the
validity and reliability of that educational standardized assessment or
educational assessment. If a [business](#1798.140(d)) does not comply with a request
pursuant to this section, it shall notify the [consumer](#1798.140(i)) that it is acting
...
information that would provide an advantage to the [consumer](#1798.140(i)) who has
submitted a [verifiable consumer request](#1798.140(ak)) or to another natural [person](#1798.140(u)).*

*(r) Sections 1798.105 and 1798.120 shall not apply to a [business](#1798.140(d))\'s
use, disclosure, or [sale](#1798.140(ad)) of particular pieces of a [consumer](#1798.140(i))\'s [personal
information](#1798.140(v)) if the [consumer](#1798.140(i)) has consented to the [business](#1798.140(d))\'s use,
disclosure, or [sale](#1798.140(ad)) of that information to produce a physical item such
as a school yearbook containing the [consumer](#1798.140(i))\'s photograph if:*

*(1) The [business](#1798.140(d)) has incurred significant expense in reliance on the
[consumer](#1798.140(i))\'s [consent](#1798.140(h));*

*(2) Compliance with the [consumer](#1798.140(i))\'s request to opt-out of the [sale](#1798.140(ad)) of
the [consumer](#1798.140(i))\'s [personal information](#1798.140(v)) or to delete the [consumer](#1798.140(i))\'s
[personal information](#1798.140(v)) would not be commercially reasonable; and*

*(3) The [business](#1798.140(d)) complies with the [consumer](#1798.140(i))\'s request as soon as it is
commercially reasonable to do so.*

*SEC. 16. Section 1798.150 of the Civil Code is amended to read:*

*1798.150. [Personal Information](#1798.140(v)) Security Breaches*

1798.150

\(a)

\(1) Any [consumer](#1798.140(i)) whose nonencrypted and nonredacted [personal
information](#1798.140(v)), as defined in subparagraph (A) of paragraph (1) of
...
exfiltration, theft, or disclosure as a result of the [business](#1798.140(d))'s
...
protect the [personal information](#1798.140(v)) may institute a civil action for any of
the following:
...
[consumer](#1798.140(i)) per incident or actual damages, whichever is greater.
...
\(b) Actions pursuant to this section may be brought by a [consumer](#1798.140(i)) if,
prior to initiating any action against a [business](#1798.140(d)) for statutory damages
on an individual or class-wide basis, a [consumer](#1798.140(i)) provides a [business](#1798.140(d)) 30
days' written notice identifying the specific provisions of this title
the [consumer](#1798.140(i)) alleges have been or are being violated. In the event a
cure is possible, if within the 30 days the [business](#1798.140(d)) actually cures the
noticed violation and provides the [consumer](#1798.140(i)) an express written statement
...
statutory damages may be initiated against the [business](#1798.140(d)). *The
...
required prior to an individual [consumer](#1798.140(i)) initiating an action solely for
actual pecuniary damages suffered as a result of the alleged violations
of this title. If a [business](#1798.140(d)) continues to violate this title in breach
of the express written statement provided to the [consumer](#1798.140(i)) under this
section, the [consumer](#1798.140(i)) may initiate an action against the [business](#1798.140(d)) to
...
\(a)  Any [business](#1798.140(d)), [service provider](#1798.140(ag)), *[contractor](#1798.140(j))* or other
[person](#1798.140(u)) that violates this title shall be  liable for *an administrative fine of not more than two thousand
...
violations involving the [personal information](#1798.140(v)) of [consumers](#1798.140(i)) whom the
[business](#1798.140(d)), [service provider](#1798.140(ag)), [contractor](#1798.140(j)) or other [person](#1798.140(u)) has actual
...
brought pursuant to subdivision (*a*), shall be deposited in the
[Consumer](#1798.140(i)) Privacy Fund, created within the General Fund pursuant to
...
*1798.160. [Consumer](#1798.140(i)) Privacy Fund*

1798.160

\(a) A special fund to be known as the "[Consumer](#1798.140(i)) Privacy Fund" is hereby
...
enforce this title*, the*  costs incurred by the Attorney
...
[consumer](#1798.140(i)) privacy, educate children in the area of online privacy, and
fund cooperative programs with international law enforcement
organizations to combat fraudulent activities with respect to [consumer](#1798.140(i))
data breaches*.

\(b) Funds transferred to the [Consumer](#1798.140(i)) Privacy Fund shall be used
...
*(i) non-profit organizations to promote and protect [consumer](#1798.140(i)) privacy;*
...
fraudulent activities with respect to [consumer](#1798.140(i)) data breaches.*

*(c)*  *Funds in the [Consumer](#1798.140(i)) Privacy Fund* shall not be
...
and to supplement existing laws relating to [consumers](#1798.140(i))' [personal
information](#1798.140(v)), including, but not limited to, Chapter 22 (commencing with
Section 22575) of Division 8 of the [Business](#1798.140(d)) and Professions Code and
Title 1.81 (commencing with Section 1798.80). The provisions of this
title are not limited to information [collected](#1798.140(f)) electronically or over
the Internet, but apply to the [collection](#1798.140(f)) and [sale](#1798.140(ad)) of all [personal
information](#1798.140(v)) [collected](#1798.140(f)) by a [business](#1798.140(d)) from [consumers](#1798.140(i)). Wherever possible,
law relating to [consumers](#1798.140(i))' [personal information](#1798.140(v)) should be construed to
...
of privacy for [consumers](#1798.140(i)) shall control.
...
the [collection](#1798.140(f)) and [sale](#1798.140(ad)) of [consumers](#1798.140(i))' [personal information](#1798.140(v)) by a
[business](#1798.140(d)).
...
information](#1798.140(v)) to those enumerated in subdivision (c) of Section 1798.130
and subdivision (*v*) of Section 1798.140*, and updating or adding
categories of [sensitive personal information](#1798.140(ae)) to those enumerated in
subdivision (ae) of Section 1798.140,* in order to address changes in
technology, data [collection](#1798.140(f)) practices, obstacles to implementation, and
privacy concerns.

\(2) Updating as needed the definition*s* of *"[deidentified](#1798.140(m))" and *"[unique
identifier](#1798.140(aj))" to address changes in technology, data [collection](#1798.140(f)),
obstacles to implementation, and privacy concerns, and *adding,
modifying, or deleting* categories to the definition of
[designated methods for submitting requests](#1798.140(n)) to facilitate a [consumer](#1798.140(i))'s
ability to obtain information from a [business](#1798.140(d)) pursuant to Section
1798.130. *The authority to update the definition of "[deidentified](#1798.140(m))"
...
\(A) To facilitate and govern the submission of a request by a [consumer](#1798.140(i))
to opt-out of the [sale](#1798.140(ad)) *or [sharing](#1798.140(ah))* of [personal information](#1798.140(v)) pursuant to
Section 1798.120 *and to limit the use of a [consumer](#1798.140(i))'s [sensitive
personal information](#1798.140(ae)) pursuant to section 1798.121 to ensure that
[consumers](#1798.140(i)) have the ability to exercise their choices without undue
burden and to prevent [business](#1798.140(d)) from engaging in deceptive or harassing
conduct, including in retaliation against [consumers](#1798.140(i)) for exercising their
rights, while allowing [businesses](#1798.140(d)) to inform [consumers](#1798.140(i)) of the
consequences of their decision to opt-out of the [sale](#1798.140(ad)) or [sharing](#1798.140(ah)) of
their [personal information](#1798.140(v)) or to limit the use of their [sensitive
personal information](#1798.140(ae))*.

\(B) To govern [business](#1798.140(d)) compliance with a [consumer](#1798.140(i))'s opt-out request.

\(C) For the development and use of a recognizable and uniform opt-out
logo or button by all [businesses](#1798.140(d)) to promote [consumer](#1798.140(i)) awareness of the
opportunity to opt-out of the [sale](#1798.140(ad)) of [personal information](#1798.140(v)).

\(5) Adjusting the monetary threshold*s, in January of every odd-numbered
year to reflect any increase in the [Consumer](#1798.140(i)) Price Index,* in
subparagraph (A) of paragraph (1) of subdivision (*d*) of Section
1798.140*; subparagraph (A) of paragraph (1) of subdivision (a) of
Section 1798.150; subdivision (A) of Section 1798.155; Section
1798.199.25; and subdivision (a) of section 1798.199.90*.

\(6) Establishing rules, procedures, and any exceptions necessary to
ensure that the notices and information that [businesses](#1798.140(d)) are required to
provide pursuant to this title are provided in a manner that may be
easily understood by the average [consumer](#1798.140(i)), are accessible to [consumers](#1798.140(i))
with disabilities, and are available in the language primarily used to
interact with the [consumer](#1798.140(i)), including establishing rules and guidelines
regarding financial incentive s, within one year of passage
...
[consumer](#1798.140(i))'s or the [consumer](#1798.140(i))'s authorized agent's ability to *delete
[personal information](#1798.140(v)), correct inaccurate [personal information](#1798.140(v)) pursuant
...
[consumers](#1798.140(i)), taking into account available technology, security concerns,
and the burden on the [business](#1798.140(d)), to govern a [business](#1798.140(d))'s determination
that a request for information received from a [consumer](#1798.140(i)) is a [verifiable
consumer request](#1798.140(ak)), including treating a request submitted through a
password-protected account maintained by the [consumer](#1798.140(i)) with the [business](#1798.140(d))
while the [consumer](#1798.140(i)) is logged into the account as a [verifiable consumer
request](#1798.140(ak)) and providing a mechanism for a [consumer](#1798.140(i)) who does not maintain
an account with the [business](#1798.140(d)) to request information through the
[business](#1798.140(d))'s authentication of the [consumer](#1798.140(i))'s identity, within one year of
passage of this title and as needed thereafter.

*(8) Establishing how often, and under what circumstances, a [consumer](#1798.140(i))
may request a correction pursuant to Section 1798.106, including
standards governing:*

*(A) how a [business](#1798.140(d)) responds to a request for correction, including
...
*(C) the steps a [business](#1798.140(d)) may take to prevent fraud; and*

*(D) if a [business](#1798.140(d)) rejects a request to correct [personal information](#1798.140(v))
[collected](#1798.140(f)) and analyzed concerning a [consumer](#1798.140(i))\'s health, the right of a
[consumer](#1798.140(i)) to provide a written addendum to the [business](#1798.140(d)) with respect to
any item or statement regarding any such [personal information](#1798.140(v)) that the
[consumer](#1798.140(i)) believes to be incomplete or incorrect. The addendum shall be
limited to 250 words per alleged incomplete or incorrect item and shall
clearly indicate in writing that the [consumer](#1798.140(i)) requests the addendum to
be mode a port of the [consumer](#1798.140(i))\'s record.*

*(9) Establishing the standard to govern a [business](#1798.140(d))\'s determination,
...
in a response to a [verifiable consumer request](#1798.140(ak)) is impossible or would
involve a disproportionate effort.*

*(10) Issuing regulations further defining and adding to the [business
purposes](#1798.140(e)), including other notified purposes, for which [businesses](#1798.140(d)),
[service providers](#1798.140(ag)), and [contractors](#1798.140(j)) may use [consumers](#1798.140(i))\' [personal
information](#1798.140(v)) consistent with [consumers](#1798.140(i))\' expectations, and further
defining the [business purposes](#1798.140(e)) for which [service providers](#1798.140(ag)) and
[contractors](#1798.140(j)) may combine [consumers](#1798.140(i))\' [personal information](#1798.140(v)) obtained from
different sources, except as provided for in paragraph (6) of
subdivision (e) of Section 1798.140.*

*(11) Issuing regulations identifying those [business purposes](#1798.140(e)), including
other notified purposes, for which [service providers](#1798.140(ag)) and [contractors](#1798.140(j)) may
use [consumers](#1798.140(i))\' [personal information](#1798.140(v)) received pursuant to a written
contract with a [business](#1798.140(d)), for the [service provider](#1798.140(ag)) or [contractor](#1798.140(j))\'s own
[business purposes](#1798.140(e)), with the goal of maximizing [consumer](#1798.140(i)) privacy.*

*(12) Issuing regulations to further define \"[intentionally interacts](#1798.140(s)),\"
with the goal of maximizing [consumer](#1798.140(i)) privacy.*

*(13) Issuing regulations to further define \"[precise geolocation](#1798.140(w)),\"
such as where the size defined is not sufficient to protect [consumer](#1798.140(i))
privacy in sparsely populated areas, or when the [personal information](#1798.140(v)) is
used for normal operational purposes, such as billing.*

*(14) Issuing regulations to define the term \"specific pieces of
information obtained from the [consumer](#1798.140(i))\" with the goal of maximizing a
[consumer](#1798.140(i))\'s right to access relevant [personal information](#1798.140(v)) while
minimizing the delivery of information to a [consumer](#1798.140(i)) that would not be
useful to the [consumer](#1798.140(i)), such as system log information and other
technical data. For delivery of the most [sensitive personal information](#1798.140(ae)),
...
on the right of [consumers](#1798.140(i)) to obtain their [personal information](#1798.140(v)) to ensure
that the requirements of verification do not result in the unreasonable
denial of [verifiable consumer requests](#1798.140(ak)).*

*(15) Issuing regulations requiring [businesses](#1798.140(d)) whose [processing](#1798.140(y)) of
[consumers](#1798.140(i))\' [personal information](#1798.140(v)) presents significant risk to
[consumers](#1798.140(i))\' privacy or security, to:*
...
in determining when [processing](#1798.140(y)) may result in significant risk to the
security of [personal information](#1798.140(v)) shall include the size and complexity
of the [business](#1798.140(d)) and the nature and scope of [processing](#1798.140(y)) activities,*

*(B) submit to the California Privacy Protection Agency on a regular
basis a risk assessment with respect to their [processing](#1798.140(y)) of [personal
information](#1798.140(v)), including whether the [processing](#1798.140(y)) involves [sensitive
personal information](#1798.140(ae)), and identifying and weighing the benefits
resulting from the [processing](#1798.140(y)) to the [business](#1798.140(d)), the [consumer](#1798.140(i)), other
stakeholders, and the public, against the potential risks to the rights
of the [consumer](#1798.140(i)) associated with such [processing](#1798.140(y)), with the goal of
restricting or prohibiting such [processing](#1798.140(y)) if the risks to privacy of
the [consumer](#1798.140(i)) outweigh the benefits resulting from [processing](#1798.140(y)) to the
[consumer](#1798.140(i)), the [business](#1798.140(d)), other stakeholders, and the public. Nothing in
this section shall require a [business](#1798.140(d)) to divulge trade secrets.*

*(16) Issuing regulations governing access and opt-out rights with
respect to [businesses](#1798.140(d))\' use of automated decision-making technology,
including [profiling](#1798.140(z)) and requiring [businesses](#1798.140(d))\' response to access
...
the process with respect to the [consumer](#1798.140(i)).*
...
selection of [persons](#1798.140(u)) to audit, and to protect [consumers](#1798.140(i))\' [personal
information](#1798.140(v)) from disclosure to an auditor, in the absence of a court
...
technology, or mechanism, to indicate a [consumer](#1798.140(i))\'s intent to opt-out of
the [sale](#1798.140(ad)) or [sharing](#1798.140(ah)) of the [consumer](#1798.140(i))\'s [personal information](#1798.140(v)) and to limit
the use or disclosure of the [consumer](#1798.140(i))\'s [sensitive personal information](#1798.140(ae)).
...
[consumers](#1798.140(i)) interact with [businesses](#1798.140(d)), and should:*

*(i) ensure that the manufacturer of a platform or browser or [device](#1798.140(o))
that sends the opt-out preference signal cannot unfairly disadvantage
another [business](#1798.140(d));*

*(ii) ensure that the opt-out preference signal is consumer1riendiy,
clearly described, and easy to use by an average [consumer](#1798.140(i)), and does not
require that the [consumer](#1798.140(i)) provide additional information beyond what is
necessary;*

*(iii) clearly represent a [consumer](#1798.140(i))\'s intent and be free of defaults
constraining or presupposing such intent;*

*(iv) ensure that the opt-out preference signal does not conflict with
other commonly-used privacy settings or tools that [consumers](#1798.140(i)) may employ;
*

*(v) provide a mechanism for the [consumer](#1798.140(i)) to selectively [consent](#1798.140(h)) to a
[business](#1798.140(d))'s [sale](#1798.140(ad)) of the [consumer](#1798.140(i))\'s [personal information](#1798.140(v)), or the use or
disclosure of the [consumer](#1798.140(i))\'s [sensitive personal information](#1798.140(ae)), without
affecting their preferences with respect to other [businesses](#1798.140(d)) or
disabling the opt-out preference signal globally; and*

*(vi) state that in the case of a page or setting view which the
[consumer](#1798.140(i)) accesses to set the opt-out preference signal, the [consumer](#1798.140(i))
should see up to three choices, including*

*(a.) a global opt-out from [sale](#1798.140(ad)) and [sharing](#1798.140(ah)) of [personal information](#1798.140(v)),
including a direction to limit the use of [sensitive personal
information](#1798.140(ae));*

*(b.) a choice to \"Limit The Use Of My [Sensitive Personal Information](#1798.140(ae))\";
and*

*(c.) a choice titled \"Do Not [Sell](#1798.140(ad))/Do Not [Share](#1798.140(ah))/Do Not [Share](#1798.140(ah)) My [Personal
Information](#1798.140(v)) for [Cross-Context Behavioral Advertising](#1798.140(k)),\"*

*(B) Issuing regulations to establish technical specifications for an
opt-out preference signal that allows the [consumer](#1798.140(i)), or the [consumer](#1798.140(i))\'s
parent or guardian, to specify that the [consumer](#1798.140(i)) is less than 13 years
of age or at least 13 years of age and less than 16 years of age.*

*(C) Issuing regulations, with the goal of strengthening [consumer](#1798.140(i))
privacy, while considering the legitimate operational interests of
[businesses](#1798.140(d)), to govern the use or disclosure of a [consumer](#1798.140(i))\'s [sensitive
personal information](#1798.140(ae)), notwithstanding the [consumer](#1798.140(i))\'s direction to limit
the use or disclosure of the [consumer](#1798.140(i))\'s [sensitive personal information](#1798.140(ae)),
including:*

*(i) determining any additional purposes for which a [business](#1798.140(d)) may use or
disclose a [consumer](#1798.140(i))\'s [sensitive personal information](#1798.140(ae));*
...
health-related [research](#1798.140(ab));*

*(iii) ensuring the functionality of the [business](#1798.140(d))\'s operations; and*

*(iv) ensuring that the exemption in subdivision (d) of Section 1798.121
or [sensitive personal information](#1798.140(ae)) applies to information that is
[collected](#1798.140(f)) or processed incidentally, or without the purpose of [inferring](#1798.140(r))
characteristics about a [consumer](#1798.140(i)), while ensuring that [businesses](#1798.140(d)) do not
use the exemption for the purpose of evading [consumers](#1798.140(i))\' rights to limit
the use and disclosure of their [sensitive personal information](#1798.140(ae)) under
Section 1798.121.*

*(20) Issuing regulations to govern how a [business](#1798.140(d)) that has elected to
comply with subdivision (b) of Section 1798.135 responds to the opt-out
preference signal and provides [consumers](#1798.140(i)) with the opportunity
subsequently to [consent](#1798.140(h)) to the [sale](#1798.140(ad)) or [sharing](#1798.140(ah)) of their [personal
information](#1798.140(v)) or the use and disclosure of their [sensitive personal
information](#1798.140(ae)) for purposes in addition to those authorized by subdivision
(a) of Section 1798.121. The regulations should:*

*(A) strive to promote competition and [consumer](#1798.140(i)) choice and be technology
neutral;*

*(B) ensure that the [business](#1798.140(d)) does not respond to an opt-out preference
signal by:*

*(i) intentionally degrading the functionality of the [consumer](#1798.140(i))
experience;*

*(ii) charging the [consumer](#1798.140(i)) a fee in response to the [consumer](#1798.140(i))\'s opt-out
preferences;*

*(iii) making any products or [services](#1798.140(af)) not function properly or fully
for the [consumer](#1798.140(i)), as compared to [consumers](#1798.140(i)) who do not use the opt-out
preference signal;*

*(iv) attempting to coerce the [consumer](#1798.140(i)) to opt-in to the [sale](#1798.140(ad)) or [sharing](#1798.140(ah))
of their [personal information](#1798.140(v)), or the use or disclosure of their
[sensitive personal information](#1798.140(ae)), by stating or implying that the use of
the opt-out preference signal will adversely affect the [consumer](#1798.140(i)) as
compared to [consumers](#1798.140(i)) who do not use the opt-out preference signal,
including stating or implying that the [consumer](#1798.140(i)) will not be able to use
the [business](#1798.140(d))\'s products or [services](#1798.140(af)), or that such products or [services](#1798.140(af))
may not function properly or fully; or*

*(v) displaying any notification or pop-up in response to the
[consumer](#1798.140(i))\'s opt-out preference signal; and*

*(C) ensure that any link to a webpage or its supporting content that
allows the [consumer](#1798.140(i)) to [consent](#1798.140(h)) to opt-in:*

*(i) Is not part of a popup, notice, banner, or other intrusive design
that obscures any part of the webpage the [consumer](#1798.140(i)) intended to visit
from full view, or that interferes with or impedes in any way the
[consumer](#1798.140(i))\'s experience visiting or browsing the webpage or website the
[consumer](#1798.140(i)) intended to visit;*

*(ii) does not require or imply that the [consumer](#1798.140(i)) must click the link to
receive full functionality of any products or [services](#1798.140(af)), including the
website;*

*(iii) does not make use of any [dark patterns](#1798.140(l)); and*

*(iv) applies only to the [business](#1798.140(d)) with which the [consumer](#1798.140(i)) intends to
...
unduly restrict [businesses](#1798.140(d)) that are trying in good faith to comply with
Section 1798.135.*

*(21) Review existing California Insurance Code provisions and
regulations relating to [consumer](#1798.140(i)) privacy, except those relating to
insurance rates or pricing, to determine whether any provisions of the
Insurance Code provide greater protection to [consumers](#1798.140(i)) than the
...
to [consumers](#1798.140(i)), and other operational mechanisms in this title to promote
clarity and the functionality of this title for [consumers](#1798.140(i)).*
...
[verifiable consumer requests](#1798.140(ak)) for specific pieces of [personal information](#1798.140(v))
relating to a [household](#1798.140(q)) in order to address obstacles to implementation
...
Enforcement of provisions of law contained in the California [Consumer](#1798.140(i))
...
of information by a [business](#1798.140(d)) to a [third party](#1798.140(ai)) in order to avoid the
definition of [sell](#1798.140(ad)) *or [share](#1798.140(ah)), or*

*(b) if steps or transactions were taken to purposely avoid the
definition of [sell](#1798.140(ad)) or [share](#1798.140(ah)) by eliminating any monetary or other
...
where a party is obtaining something of value or use*.
...
way  rights under this title, including, but not limited
...
section shall not prevent a [consumer](#1798.140(i)) from declining to request
information from a [business](#1798.140(d)), declining to opt-out of a [business](#1798.140(d))'s [sale](#1798.140(ad))
of the [consumer](#1798.140(i))'s [personal information](#1798.140(v)), or authorizing a [business](#1798.140(d)) to
[sell](#1798.140(ad)) *or [share](#1798.140(ah))* the [consumer](#1798.140(i))'s [personal information](#1798.140(v)) after previously
opting *-*out.
...
17-0039, The [Consumer](#1798.140(i)) Right to Privacy Act of 2018, is withdrawn from
...
Californla [Consumer](#1798.140(i)) Privacy Act. The Agency shall be governed by a
...
expertise in the areas of privacy, technology, and [consumer](#1798.140(i)) rights.*
...
accepting employment with a [business](#1798.140(d)) that was subject to an enforcement
...
representing any other [person](#1798.140(u)) in a matter pending before the Agency if
...
consistent with applicable civil [service](#1798.140(af)) laws, and shall fix the
compensation of employees and prescribe their duties. The Agency may
contract for [services](#1798.140(af)) that cannot be provided by its employees.*
...
the purposes and provisions of the California [Consumer](#1798.140(i)) Privacy Act,
including regulations specifying record keeping requirements for
[businesses](#1798.140(d)) to ensure compliance with this title.*

*(c) Through the implementation of this title, protect the fundamental
privacy rights of natural [persons](#1798.140(u)) with respect to the use of their
[personal information](#1798.140(v)).*

*(d) Promote public awareness and understanding of the risks, rules,
responsibilities, safeguards, and rights in relation to the [collection](#1798.140(f)),
use, [sale](#1798.140(ad)) and disclosure of [personal information](#1798.140(v)), including the rights
...
*(e) Provide guidance to [consumers](#1798.140(i)) regarding their rights under this
title.*

*(f) Provide guidance to [businesses](#1798.140(d)) regarding their duties and
responsibilities under this title, and appoint a Chief Privacy Auditor
to conduct audits of [businesses](#1798.140(d)) to ensure compliance with this title
...
[personal information](#1798.140(v)), and in particular, the development of information
...
and with data [processing](#1798.140(y)) authorities in California, other states,
territories, and countries to ensure consistent application of privacy
protections.*

*(j) Establish a mechanism pursuant to which [persons](#1798.140(u)) doing [business](#1798.140(d)) in
California that do not meet the definition of [business](#1798.140(d)) set forth in
...
strengthening [consumer](#1798.140(i)) privacy while giving attention to the impact on
[businesses](#1798.140(d)),*

*1798.199.45.*

*Upon the sworn complaint of any [person](#1798.140(u)) or on its own initiative, the
Agency may investigate possible violations of this title relating to any
[business](#1798.140(d)), [service provider](#1798.140(ag)), [contractor](#1798.140(j)), or [person](#1798.140(u)). The Agency may decide
not to investigate a complaint or decide to provide a [business](#1798.140(d)) with a
...
*(b) voluntary efforts undertaken by the [business](#1798.140(d)), [service provider](#1798.140(ag)),
[contractor](#1798.140(j)), or [person](#1798.140(u)) to cure the alleged violation prior to being
notified by the Agency of the complaint. The Agency shall notify in
writing the [person](#1798.140(u)) who mode the complaint of the action, if any, the
...
Agency\'s consideration of the alleged violation, the [business](#1798.140(d)), [service
provider](#1798.140(ag)), [contractor](#1798.140(j)), or [person](#1798.140(u)) alleged to have violated this title is
notified of the violation by [service](#1798.140(af)) of process or registered mall with
return receipt requested, provided with a summary of the evidence, and
informed of their right to be present in [person](#1798.140(u)) and represented by
counsel at any proceeding of the Agency held for the purpose of
considering whether probable cause exists for believing the [person](#1798.140(u))
violated this title. Notice to the alleged violator shall be deemed made
on the date of [service](#1798.140(af)), the date the registered mail receipt is signed,
...
violation and each violation involving the [personal information](#1798.140(v)) of minor
[consumers](#1798.140(i)) to the [Consumer](#1798.140(i)) Privacy Fund within the General Fund of the
state. When the Agency determines that no violation has occurred, it
shall publish a declaration so stating.*

*(b) If two or more [persons](#1798.140(u)) are responsible for any violation or
...
powers, including but not limited to its power to audit a [business](#1798.140(d))\'s
...
*(a) The [service](#1798.140(af)) of the probable cause hearing notice, as required by
Section 1798.199.50, upon the [person](#1798.140(u)) alleged to have violated this title
shall constitute the commencement of the administrative action.*

*(b) If the [person](#1798.140(u)) alleged to have violated this title engages in the
...
of this subdivision, "fraudulent concealment\" means the [person](#1798.140(u)) knows of
...
the [person](#1798.140(u)) alleged to have violated this title fails to produce
...
[collecting](#1798.140(f)) any unpaid administrative fines imposed pursuant to this
...
a judgment to [collect](#1798.140(f)) the administrative fines imposed by the order or
...
judicial review, and proof of [service](#1798.140(af)) of the order or decision,
constitutes a sufficient showing to warrant issuance of the judgment to
[collect](#1798.140(f)) the administrative fines. The clerk of the court shall enter the
...
*(a) Any [business](#1798.140(d)), [service provider](#1798.140(ag)), [contractor](#1798.140(j)), or other [person](#1798.140(u)) that
...
the [personal information](#1798.140(v)) of minor [consumers](#1798.140(i)), as adjusted pursuant to
...
consider the· good faith cooperation of the [business](#1798.140(d)), [service provider](#1798.140(ag)),
[contractor](#1798.140(j)), or other [person](#1798.140(u)) in determining the amount of the civil
penalty.*
...
settlement of any said action, shall be deposited in the [Consumer](#1798.140(i))
Privacy Fund.*
...
1798.199.55 against that [person](#1798.140(u)) for the same violation.*
...
General shall be reimbursed by the Agency for these [services](#1798.140(af)).*

*1798.199.100.*

*The Agency and any court, as applicable, shall consider the good faith
cooperation of the [business](#1798.140(d)), [service provider](#1798.140(ag)), [contractor](#1798.140(j)), or other
[person](#1798.140(u)) in determining the amount of any administrative fine or civil
penalty for a violation of this title. A [business](#1798.140(d)) shall not be required
...
additional compensation for members of the California [Consumer](#1798.140(i)) Privacy
...
application of any provision or part to any [person](#1798.140(u)) or circumstances, is
...
[consumer](#1798.140(i)) privacy shall appear on the same statewide ballot, the
...
[personal information](#1798.140(v)) [collected](#1798.140(f)) by a [business](#1798.140(d)) on or after January 1,
2022.*
...
*(c) The provisions of the California [Consumer](#1798.140(i)) Privacy Act of 2018,
