...
#python process-html.py html/cpra-both.html both.html
python process-html.py html/cpra-new.html new.html
#python process-html.py html/cpra-old.html old.html
